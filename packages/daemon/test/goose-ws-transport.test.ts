...
describe("withToken", () => {
  ...
  it("preserves query parameters that are already present", () => {
    const out = new URL(withToken("ws://127.0.0.1:3400/acp?mode=stream", "s3cret"));
